...
export default function BirdSightingInfo({ comName, sciName, locName, obsDt, howMany, subId, compact = false }) {
    ...
    <div>
      ...
      <div style={{ marginTop: compact ? 10 : 16, display: 'flex', flexDirection: 'column', gap }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
          ...
          <span style={{ color: 'var(--color-text)', fontSize: factSize, lineHeight: 1.4 }}>{formatLocName(locName)}</span>
        </div>
